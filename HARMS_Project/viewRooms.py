...
cur.execute("SELECT room_id,room_name,room_state FROM rooms ")

print("<br>")

print("<center><h1>Rooms Information</h1></center>")
print("<table style='border: 1px solid black' width=70% align=center bgcolor=#f0f0f5")
print("<tr><td style='font-family: Times New Roman, Times, serif;font-size:40px'><strong>ID</strong></td><td style='font-family: Times New Roman, Times, serif;font-size:40px'><strong>Room Name</strong></td><td style='font-family: Times New Roman, Times, serif;font-size:40px'><strong>Motion State</strong></td><td>")

for (room_id,room_name,room_state ) in cur:
    print("<tr><td style='font-family: Times New Roman, Times, serif;font-size:30px'>",room_id,"</td><td style='font-family: Times New Roman, Times, serif;font-size:30px'>",room_name,"</td><td style='font-family: Times New Roman, Times, serif;font-size:30px'>",room_state ,"</td></tr>")
