...
<a href="Setting.php" class="p-2 " ><img src="img/setting2.png" class="img-fluid " alt="setting_pic" style="width:50px; height: 50px"></a>
  ...
  <center > <div class="col-md-4 p-2">
               <div class="card mt-50 ">
                   <div class="card-body border rounded shadow-sm " style="background-color:#f0f0f5; height:420px ">
                        <form class="form mt-2" action="AddAppliance.py" method="post" >
                           <h3 class="text-center text-warning font-weight-bolder" style="font-size:40px;font-family: Times New Roman, Times, serif">Add Appliance</h3>

                            <label  style="font-family: Times New Roman, Times, serif;font-size:20px"> Appliance Name: </label><br>
                            <input type="text"  class="form-control" name="appname"><br>
                            <label  style="font-family: Times New Roman, Times, serif;font-size:20px"> Room ID: </label><br>
                            <input type="text"  class="form-control" name="roomid"><br>
