...
cur.execute("SELECT sensor_id ,Appliance_id,sensor_type FROM sensors ")


print("<br>")

print("<center><h1>Sensors Information</h1></center>")
print("<table style='border: 1px solid black' width=80% align=center bgcolor=#f0f0f5")
print("<tr><td style='font-family: Times New Roman, Times, serif;font-size:40px'><strong>ID  </strong></td><td style='font-family: Times New Roman, Times, serif;font-size:40px'><strong> Appliance id</strong><td style='font-family: Times New Roman, Times, serif;font-size:40px'><strong>Sensor Type</strong></td><tr>")

for (sensor_id ,Appliance_id,sensor_type ) in cur:
    print("<tr><td style='font-family: Times New Roman, Times, serif;font-size:30px'>",sensor_id,"</td><td style='font-family: Times New Roman, Times, serif;font-size:30px'>",Appliance_id,"</td><td style='font-family: Times New Roman, Times, serif;font-size:30px'>",sensor_type ,"</td></tr>")
