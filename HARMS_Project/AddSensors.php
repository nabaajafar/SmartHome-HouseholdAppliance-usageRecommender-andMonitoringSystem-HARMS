...
<a href="Setting.php" class="p-2 " ><img src="img/setting2.png" class="img-fluid " alt="setting_pic" style="width:50px; height: 50px"></a>
  ...
  <center> <div class="col-md-4 p-2">
               <div class="card mt-50 ">
                   <div class="card-body border rounded shadow-sm " style="background-color:#f0f0f5; height:400px ">
                        <form class="form mt-2" action="AddSensors.py" method="post" >
                           <h3 class="text-center text-warning font-weight-bolder" style="font-size:40px;font-family: Times New Roman, Times, serif">Add Sensor</h3>

                            <label  style="font-family: Times New Roman, Times, serif;font-size:20px"> Sensor type: </label>
                               <select style="font-family: Times New Roman, Times, serif;font-size:20px"  class=" fit" name="select_type">
                               <option value="Motion Sensor">Motion Sensor</option>
                              <option value="Light Sensor">Light Sensor</option>
                              <option value="Current Transformer Sensor">Current Transformer Sensor</option>
                              <option value="Relay Module">Relay Module</option>
                              </select><br><br>

                            <label  style="font-family: Times New Roman, Times, serif;font-size:20px"> Appliance ID: </label><br>
                            <input type="text"  class="form-control" name="appid"><br>
...
<?php if(@$_GET['isempty']==TRUE) {?>
 ...
 <?php if(@$_GET['err']==TRUE) {?>
                <div class="alert-light py-3 rounded" style="background-color: #ffcccc ;
                 color: #990000"><?php echo @$_GET['err'];?></div>
                <?php }?>
                    </div>
                    </div>
